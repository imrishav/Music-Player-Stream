...
<div id="loginContainer">
	<div id="inputContainer">
		<form id="formElem" method="post" enctype="multipart/form-data">
			...
			<p class="errors" style="display: none; font-size:22px;">Please Fill All Fields</P>
			<p>
				<label for="songTitle">Song Name</label>
				<input id="songTitle" name="songTitle" type="text" placeholder=""  autocomplete="off" required/>
			</p>
			<p>
				<label for="artist">
					Artist Name :
					<select class="selectForAdmin" name="artist" id="artitName">
			...
			<p>
				...
				<label>AlbumName:
					...
					<select class="selectForAdmin" name="album">
			...
			<p>
				<label>
					...
					<select class="selectForAdmin" name="genre">
			...
			<input id='buttonForAdmin' type="submit" onclick="formadd(event)" value="Upload File" name="submit">
	...
	<div id="inputContainer">
		<form id="formElem" method="post" enctype="multipart/form-data">
			...
			<input id='imagesss' type="file" name="files[]" multiple>
				...
				<input id='buttonForAdmin' type="submit" onclick="albumAdd(event)" value="Add Album" name="submit">
	...
	<script>
		...
		function formadd(event) {
			...
			$inputs.each(function() {
				values[this.name] = $(this).val();
				if($(this).val().length === 0 || $(this).val() === 'empty') {
					error[this.name] = true
			...
			var allTrue = Object.keys(error).length;
